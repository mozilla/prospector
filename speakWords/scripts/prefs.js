...
function pref(key) {
  ...
  if (typeof branch == "string")
    branch = pref.branch = Services.prefs.getBranch(branch);
...
pref.defaults = {
  ...
  addDomains: true,
  addSearchKeywords: true,
  autoSelectForDomain: true,
};

// Initialize default preferences
let (branch = Services.prefs.getDefaultBranch(pref.branch)) {
